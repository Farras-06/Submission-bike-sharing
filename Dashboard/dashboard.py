...
with st.sidebar:
    st.image(
        "https://github.com/Farras-06/Submission-bike-sharing/blob/main/Dashboard/bicycle.png"
    )
    ...
    with col2:
        st.markdown(
            "![Github](https://img.icons8.com/glyph-neue/FFFFFF/github)"
        )
...
st.title(":pager: Bike-Sharing Dashboard")
...
st.caption("Copyright (c) 2023, made by Ilham Farras Adnawan")